...
namespace Poll
{
    ...
    {
        public static PollViewModel pvm = new PollViewModel();
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            RegisterPushNotifications.UploadChannel(App.pvm.MobileService);
            RegisterPushNotifications.PushNotificationReceived += RegisterPushNotifications_PushNotificationReceived;
        }
